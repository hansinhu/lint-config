const baseRule = {
  bestPractices: require('./base/best-practices').rules,
  variables: require('./base/variables').rules,
}
...
module.exports = {
  ...
  rules: Object.assign(
    ...
    }),
    {
      ...
      '@typescript-eslint/no-unused-expressions': baseRule.bestPractices['no-unused-expressions'],

      'no-undef': 'off',

      'no-use-before-define': 'off',
      '@typescript-eslint/no-use-before-define': baseRule.variables['no-use-before-define'],
    }
  ),
  overrides: [
    {
